...
Public Class Frm_NatureTerrain
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Hide()
        Frm_Start.Show()
    End Sub

    Private Sub Frm_NatureTerrain_Load(sender As Object, e As EventArgs) Handles MyBase.Load, MyBase.VisibleChanged
...
order by STR_NATURE_TERRAIN, STR_NOM_PLAGE, D_LONGUEUR_PLAGE, STR_NOMVILLE, I_NBTOURISTE, STR_NOMDEPARTEMENT, STR_NOMREGION, STR_NOMRESPONSABLE"
        ...
        While (myReader.Read())
            ...
            temp_fill = ""
            temp_length = (myReader.GetString(1)).Length()
            For i As Integer = temp_length To 14
                temp_fill += " "
            Next
            param1 = myReader.GetString(1) & temp_fill
            ...
            TextBox1.Text = TextBox1.Text & param2 & " ---      " & param0 & " ---      " & param1 & " ---      " & param2 & " ---      " & param5 & " ---      " & param6 & " ---      " & param7 & vbCrLf
            temp_fill = ""
